...
const CatelogueCard = (
  { categoryImage, title, price, mainPrice, rating, id },
  index
) => {
  return (
    <div className="mb-[50px]">
      <Link to={`/details/${id}`}>
        <div className="relative bg-[#F5F5F7] w-[300px] h-[360px] rounded-[10px]">
